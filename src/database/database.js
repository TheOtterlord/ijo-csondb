...
const CSONCollection = require("./collection");

class CSONDatabase extends Database {
    ...
    register(name, modelClass) {
        ...
        this.collections.push(new CSONCollection(name, modelClass, nodePath.join(this.path, `${name}.cson`)));
    }
